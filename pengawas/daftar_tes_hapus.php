...
<table class="table table-bordered table-striped table-sm align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
<a class="btn btn-primary" href="hapus_tes.php?id=<?= $row['id_ujian'];?>&hal=<?= $hal;?>" onclick="return confirm('Yakin mengunduh menghapus tes ini?')">
Hapus</a>                                                    
                                                </td>
                                            </tr>
                                            <?php } ?>
...
if($hal == 0)
{
	echo '<a href="daftar_tes_hapus.php?hal=1">Halaman Selanjutnya</a>'; 
}
elseif($hal == 1)
{
	echo '<a href="daftar_tes_hapus.php">Halaman Sebelumnya</a> '; 
	echo '<a href="daftar_tes_hapus.php?hal=2">Halaman Selanjutnya</a> '; 
}
else
{
	$prev = $hal - 1;
	$nex = $hal + 1;
	echo '<a href="daftar_tes_hapus.php?hal='.$prev.'">Halaman Sebelumnya</a> '; 
	echo '<a href="daftar_tes_hapus.php?hal='.$nex.'">Halaman Selanjutnya</a> '; 	
}
?>
    </div>
